...
- **When about to encode knowledge in code, check whether it should be data** (ADR-231). Never
...
- Every Module carries a **Governance Section** below its Intelligence Section (ADR-232): declared,
