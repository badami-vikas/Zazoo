  ...
  try {
    ...
    await db.query(
      `INSERT INTO "rituals" ("id", "workspace_id", "agent_ids", "skill_pipeline") VALUES
        ('40000000-0000-4000-8000-000000000001', $4, ARRAY[$1]::uuid[], '[{"skill":"test_fixture_local","action":"write","resourceType":"signal"}]'),
        ('40000000-0000-4000-8000-000000000002', $4, ARRAY[$1]::uuid[], '[{"skill":"test_fixture_fetch","action":"read","resourceType":"external:fetch"}]'),
        ('40000000-0000-4000-8000-000000000003', $4, ARRAY[$1, $2]::uuid[], '[{"skill":"test_fixture_local","action":"write","resourceType":"signal"}]'),
        ('40000000-0000-4000-8000-000000000004', $4, ARRAY[$3]::uuid[], '[{"skill":"test_fixture_local","action":"write","resourceType":"signal"}]'),
