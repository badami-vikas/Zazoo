...
export type SponsorshipTier =
  ...
  // Nobody has checked yet. First-class rather than a guess (ADR-247): a row
  // added from a name on the owner's target list carries no sponsorship claim,
  // and defaulting it to "reliable" would be a fabricated figure that a
  // candidate could plan a cycle around. `sponsoringTargets()` keeps these —
  // "unchecked" is a reason to look it up, not a reason to skip the employer.
  | "unknown";
...
export const MBA_FULL_TIME_TARGETS: readonly MbaTarget[] = [
  ...
  // ── Owner's target-company list, added 2026-09-08 ──────────────────────
  // Names and role hints are the owner's own words. Nothing else about
  // these employers has been checked, so every row below is deadline:null /
  // sponsorship:"unknown" — they are the WORK QUEUE for verification, and
  // `unverifiedTargets()` is what surfaces them.
  {
    company: "Deloitte",
    role: "Internal Strategy",
    deadline: null,
    deadlineNote: "No deadline verified; added from the owner's target list.",
    sponsorship: "unknown",
    source: "Owner's target list, 2026-09-08 — roles as stated by the owner; deadline and sponsorship not verified",
    applyUrl: null,
    geography: "US",
  },
  {
    company: "World Wide Technology (WWT)",
    role: "Full-time MBA roles",
    deadline: null,
    deadlineNote: "No deadline verified; added from the owner's target list.",
    sponsorship: "unknown",
    source: "Owner's target list, 2026-09-08 — roles as stated by the owner; deadline and sponsorship not verified",
  ...
  },
  {
    ...
    role: "Corporate Restructuring Group (CRG)",
    deadline: null,
    deadlineNote: "No deadline verified; added from the owner's target list.",
    sponsorship: "unknown",
    source: "Owner's target list, 2026-09-08 — roles as stated by the owner; deadline and sponsorship not verified",
  ...
  {
    company: "Microsoft",
    role: "Product / Supply Chain / Finance (full-time MBA)",
    deadline: null,
    deadlineNote: "No deadline verified; added from the owner's target list.",
    sponsorship: "unknown",
    source: "Owner's target list, 2026-09-08 — roles as stated by the owner; deadline and sponsorship not verified",
  ...
  {
    company: "Emerson",
    role: "Strategic Planning; IT Planning",
    deadline: null,
    deadlineNote: "No deadline verified; added from the owner's target list.",
    sponsorship: "unknown",
    source: "Owner's target list, 2026-09-08 — roles as stated by the owner; deadline and sponsorship not verified",
  ...
  {
    company: "Amgen",
    role: "CLDP / FLDP (leadership development programs)",
    deadline: null,
    deadlineNote: "No deadline verified; added from the owner's target list.",
    sponsorship: "unknown",
    source: "Owner's target list, 2026-09-08 — roles as stated by the owner; deadline and sponsorship not verified",
