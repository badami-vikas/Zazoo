...
async function ensureTaskManagerAutomation(
   ...
   *  own guard Goal; TASK-090's Capability Builder Runs pass their own, so a
...
export const appRouter = t.router({
  ...
  taskManager: t.router({
    ...
    /**
     * Import the repository's canonical ledger (ADR-267).
     *
  ...
  learning: t.router({
    ...
    /**
     * TASK-090 — what has the Capability Builder actually done? Both Builder
