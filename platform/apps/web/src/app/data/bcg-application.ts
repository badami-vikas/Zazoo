...
export const BCG_APPLICATION = {
  ...
  evidence: [
    ...
    { id: 'forensics', claim: 'Reclaimed 6 of 8 enterprise clients and increased LTV 18% through an AI-enabled digital-forensics workflow.', source: 'Master Profile → PeopleGamez client projects → Bluechip Digital Forensics', status: 'verified' as const },
    ...
    { id: 'arcesium', claim: 'Built a computer-vision and NLP records workflow that reduced processing time about 30%.', source: 'Master Profile → Plaksha capstone → Arcesium', status: 'verified' as const },
  ...
  artifacts: [
    {
      ...
      sections: [
        ...
        { heading: 'Experience — PeopleGamez / MetaXP', body: 'FOUNDER & PRINCIPAL CONSULTANT · India · Aug 2021–Jul 2025 [date under review]', bullets: [
          ...
          'Reclaimed 6 of 8 enterprise clients lost to an AI-first competitor by architecting an AI-enabled digital-forensics workflow, increasing client lifetime value 18%.',
        ...
        { heading: 'Earlier education & leadership', body: 'PLAKSHA UNIVERSITY — PGDM, Tech Leaders Fellowship; full merit scholarship. Built a computer-vision/NLP workflow for Arcesium that reduced processing time ~30%.\nNIT CALICUT — B.Tech, Industrial Engineering; top 10% of class. Founding captain of the institute’s Kho-Kho team; Government of India Toycathon winner.' },
