...
type D2cSubModule = { name: string; displayName: string; summary: string; description: string };

function d2cSubModule(sub: D2cSubModule): BuiltInModuleWithSurface {
  return {
...
export const d2cResearchModule = d2cSubModule({
  name: "d2c-research",
...
export const d2cNotesModule = d2cSubModule({
  name: "d2c-notes",
  displayName: "Notes",
