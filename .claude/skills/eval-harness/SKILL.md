---
name: eval-harness
description: Use when the user wants to measure whether Claude Code output meets a quality bar — defining pass/fail criteria for a task before starting it, scoring completed sessions against those criteria, comparing two approaches or prompts on the same task, or setting up repeatable graded test cases for an agent workflow. Trigger phrases - "how do I know it worked", "define success criteria", "grade this output", "compare these two approaches".
origin: ECC
