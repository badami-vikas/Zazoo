...
interface HeaderProps {
  ...
  /** layoutId for the motion underline, must be unique per-page if multiple Headers mount */
  indicatorId?: string;
}

export function Header({ tabs, activeTab, onTabChange, indicatorId = 'segmentIndicator' }: HeaderProps) {
  return (
    <header
            ...
            >
              ...
              {active && (
                <motion.div
                  ...
                  className="absolute -bottom-[5px] left-1/2 -translate-x-1/2 w-12 h-[2px] rounded-t-full"
