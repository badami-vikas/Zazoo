...
Journal entries `0009`/`0010` and the new TASK-004 entries used timestamps beyond their repository order. FIX: timestamps are monotonic and not future-dated, `0012` remains reserved for TASK-007, and a regression checks the complete journal ordering.
