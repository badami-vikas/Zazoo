...
- [marketing-website-brief](../raw/marketing-website-platform-brief-2026-07-18.md) — **2026-07-18**: external-designer handoff for the marketing site — positioning (Living Software + DealPilot flagship), voice/avoid-list, design-system tokens, site map, open CTA/pricing question for product owner.
- [marketing-website-content](../raw/marketing-website-content-2026-07-18.md) — **2026-07-18, revised same day**: cut from 7 pages to 2 (Home + Request access) per user call — one core claim ("adapts to your work + never acts without showing you why") hit from 6 angles on a single scroll instead of spread thin across pages.
