...
- **ACTIVE TASKS** → [../TASKS.md](../TASKS.md): one reconciled queue; each task carries scope, evidence, requests, approval, status, dependencies, and prototype test. Check first. `PROGRESS.md` is historical.
