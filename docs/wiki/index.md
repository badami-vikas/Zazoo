...
- [taskmanager](taskmanager.md) — **2026-07-21, in progress (TASK-021)**: Bridge TM0–TM6 implementation landed; one recursive Task Database, governed tree surgery, agent-first projection, guards/routing/Playbooks, signed installable Module. Only `badami-vikas/Corporate-training-sims` certification remains.
