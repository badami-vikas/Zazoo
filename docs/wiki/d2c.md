...
- Orders and Inventory are D2C's own toggle Pages (`platform/modules/d2c/src/{orders,inventory}.ts`); Research and Notes are `parent: d2c` sub-modules, not top-level nav items.
