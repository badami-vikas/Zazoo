...
- **UI libs** (permissive): glide-data-grid (30k dir), @xyflow (ritual builder), @antv/g6 WebGL (map), maplibre+deck.gl, tiptap (notes + @mention links), dnd-kit (Taskade reparent), vis-timeline, qrcode.
