...
Docs: start `docs/wiki/index.md` → raw only on need. **Canonical vocabulary: `docs/glossary.md`.** Active tasks: `docs/TASKS.md` · day-zero founder/business/launch packet: `docs/day-zero/README.md` · business commit archive: `docs/commit-history/README.md` · progress pointer/rules: `docs/PROGRESS.md` · Manish resume context: `docs/Progress from Manish/README.md` · historical progress archive: `docs/raw/progress-archive-2026-07.md` · vocabulary migration: `docs/raw/vocabulary-code-migration-plan-2026-07-14.md` · vocabulary inventory/guard: `docs/raw/vocabulary-code-inventory-2026-07-19.md` · BRDs: `docs/raw/brd-dealpilot-2026-07.md`, `docs/raw/brd-jobpilot-2026-07.md` · Agent/Skill orchestration: `docs/raw/agent-goal-skill-orchestration-plan-2026-07.md` · bug evidence: `docs/BUGS.md` · ADRs: `docs/raw/decisions-log.md` · flows/ER: `docs/CODEMAPS/flows.md`.
