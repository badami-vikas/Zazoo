...
Docs: start `docs/wiki/index.md` → raw only on need. **Work tracker: `docs/PROGRESS.md`** · bugs `docs/BUGS.md` · ADRs `docs/raw/decisions-log.md` · flows/ER `docs/CODEMAPS/flows.md`.
