...
## ADR-157 — SearchProvider admission is an explicit deployment policy, not a hardcoded tier check; the second rung is the same vendor credentialed (2026-07-29; AP-089, TASK-027)
