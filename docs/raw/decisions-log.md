...
## ADR-160 — An unreadable WhatsApp address book is a read failure, not an empty address book; last-activity candidates are evaluated lazily so one dead field cannot suppress a live one (2026-08-03; TASK-030; extends ADR-158's read-allowlist section)
