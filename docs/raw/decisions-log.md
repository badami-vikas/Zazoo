...
## ADR-160 — The `table` view kind keeps two renderers behind one contract: DOM by default, Glide canvas past the virtualization threshold (2026-08-02; TASK-029)
...
## ADR-161 — Every `integration` action is a credential-access taint sink, not only reads (2026-08-02; TASK-029)
