...
## ADR-175 — The manual production-deploy gate is reversed on explicit user directive; Supabase migrations get a CI job of their own (2026-08-07; AP-102)
