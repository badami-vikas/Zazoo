...
## ADR-194 — The table is a DOM `<table>` again: canvas is removed, windowing replaces it, and the visual language stops being hand-painted (2026-08-06; owner directive; reverses ADR-160/182/192/193's renderer choice)
...
## ADR-195 — The Files Section becomes an actual file explorer, derived from paths the server already sends (2026-08-06; owner directive; AP-115)
