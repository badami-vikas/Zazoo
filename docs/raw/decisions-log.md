...
## ADR-052 — Agent-roadmap strengthening pass: dedicated Governance + Learning Agent roadmaps; per-slice exit criteria, metrics, and risk registers on JobPilot/Calendar/Builder (2026-07-12)
...
## ADR-053 — OSS code-level diligence: verified verdicts + corrections for the Learning/JobPilot/Calendar (and pending Builder) reuse maps (2026-07-13)
