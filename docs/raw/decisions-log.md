...
## ADR-035 — Single work tracker (docs/PROGRESS.md) as cursor over plan docs (2026-07-09)
...
## ADR-036 — Internal canon-change approval mechanism (docs/APPROVALS.md) (2026-07-09)
...
## ADR-037 — Consolidation trio reconciled; dummy-data policy settled (2026-07-09)
