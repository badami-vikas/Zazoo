...
- [ ] **2 — ONBOARDING-CLARITY / EG1** `[root-cause]` — replace the blueprint-centric questionnaire with EG1’s trust-first ceremony; every remaining question states why it is asked and its immediate consequence; no unexplained kernel vocabulary; add public-role-model question → governed cited Learning Agent research → approval-gated Skill/Automation recommendations; live usability evidence → `docs/raw/egg-commons-feature-roadmap-2026-07.md` §1.2/EG1 + `docs/BUGS.md` 2026-07-14 onboarding report
